  ...
  <div id="content">
    <div >
		...
		<h2>Welcome to Our Shangrila Restaurant Administration!</h2>
		   ...
		   <tr>
           <th height="42" colspan="10" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:18px; text-align:center">Online Reservations</th>
           </tr>
      </table>
		   <br />
...
?>		   
           ...
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['Booking_Date_in']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['Booking_Date_out']; ?></td>
		   <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $hal_row['Name']; ?></td>
		   <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $meal_row['Name']; ?></td>
		   <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['Payment']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <a href="delete_online_reservation.php?id=<?php echo $rows['ID']; ?>" onclick='return confirm(&quot Are you sure want to delete?&quot;)'
