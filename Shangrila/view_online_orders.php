  ...
  <div id="content">
    <div >
		...
		<h2>Welcome to Our Shangrila Restaurant Administration!</h2>
		   ...
		   <tr>
           <th height="42" colspan="10" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:18px; text-align:center"><b><h3>Online Orders</h3></th>
           </tr>
      </table>
		   <br />
