  ...
  <div id="content">
    <div >
		...
		<table width="963" height="46" border="2" cellpadding="0" cellspacing="0" bordercolor="#990000" align="center">
		   ...
		   <tr>
           <th height="42" colspan="10" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:18px; text-align:center">Feedbacks</th>
           </tr>
      </table>
		   <br />
		...
		<table width="963" height="192" border="2" cellpadding="0" cellspacing="0" bordercolor="#990000" align="center">
           ...
           <th colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">Comments</th>
...
?>		   
		   ...
		   <?php echo $rows['feedback_name']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['feedback_email']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['feedback_phone']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <?php echo $rows['feedback_comments']; ?></td>
           <td colspan="2" align="center" style="font:Georgia, 'Times New Roman', Times, serif 18px bold; color:#990000; font-size:16px;">
		   <a href="delete_feedback.php?id=<?php echo $rows['feedback_id']; ?>" onclick='return confirm(&quot Are you sure want to delete?&quot;)'
