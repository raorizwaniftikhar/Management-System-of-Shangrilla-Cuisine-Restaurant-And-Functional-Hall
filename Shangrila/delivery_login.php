		...
		<div id="archives1">                
         ...
         <div id="rightbot">
				<h2>Shangrila special dishes </h2>
					...
					<ul>
					<li>Fish crackers</li>
					<li>Shangrilla special soup</li>
					
                    <li>Chicken burger with french fries</li>
                    <li>Special Qasoori Tawa Fish</li>
                    <li>Chicken Fried Rice</li>
                    
                    <li>Shangrilla special chowmein</li>
                    <li>Shangrilla special chicken</li>
                    <li>Mutton karahi</li>
                    <li>Russian salad</li>
          	...
          	<div id="left">
			<h1>Welcome to Our Shangrilla restaurant!</h1>
			<h3><font color="#FF0000">Existing members: login now to pre-fill your details</font></h3>		
				<form action="delivery_login_action.php" method="post" name="register" ><table>
...
<tr>
<td height="32"><input name="submit" type="submit" value="Login" /></td>
<td><a href="create_account.php"><input type="button" value="Register Here" /></a></td>
</tr>
			...
			<div class="date">
				...
				<div class="text">
				<img src="images/9312_riverview_front_1_500.jpg"  width="490px"/>
			  </div>
